...
To set up your first gas policy navigate first to the [Gas Policies tab](https://dashboard.openfort.xyz/policies). Then click on the top right button `Add Policy` to start filling the Policy Information.
