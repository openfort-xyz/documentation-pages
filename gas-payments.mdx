...
When selecting `Allowed transactions` as the policy rule, you can decide what asset contract you want the gas strategy to be applied to.

Select either all or some specific functions you want your policy defined above to apply.

<div align="center">
  <img alt="policyRules" src="https://blog-cms.openfort.xyz/uploads/Screenshot_2023_05_29_at_15_53_15_40188a75a5.png" width="50%" height="50%"/>
</div>

When selecting `Register sessions` as the policy rule, the affected policy will be applied for the registration of new session keys.
...
<div align="center">
  <img alt="rewards in custom ERC-20 token" src="https://blog-cms.openfort.xyz/uploads/Screenshot_2023_05_31_at_10_02_51_1cd0c933ba.png" width="50%" height="50%"/>
</div>
