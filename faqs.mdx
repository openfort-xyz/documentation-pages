...
## Gas Policies
<strong> Can players use my own token (ERC20) to pay for gas? </strong>
...
No, Openfort you can use [policies](/gas-payments).
...
<strong>Do I have to top up the account that is funding the transactions</strong>
No, Openfort handles all the gas payments for you when with [policies](/gas-payments).
Therefore, by the end of the month, you'll receive an invoice with the total amount of gas consumed by your players.
