...
In this guide, we're going to cover patterns on how to create players for your game. To start make sure you've reveal your secret API key.
...
Note that a player can have several accounts links. Therefore, we know need to create a player to interact with digital assets like minting or airdropping in-game asset.
...
Note: The address is counterfactual, meaning you can use the same address into other EVM chains (ZkEVM is an exception for now).
