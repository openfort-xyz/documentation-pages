...
<Note>
  <strong>Note: </strong>
  <br /> Even after creating a custodial account, your can convert it to non-custodial or self-custodial by transfering its ownership. Learn more at [Transfering an Account Ownership](/transfering-an-account-ownership).
</Note>
