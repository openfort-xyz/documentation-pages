...
<Note>
  ...
  <br /> In order to execute the transaction intents above, the player should have some native tokens to pay for gas transaction.
  If you want to be able to sponsor transaction gas or allow players to pay them in ERC20, visit [Gas Payments](/gas-payments).
</Note>
